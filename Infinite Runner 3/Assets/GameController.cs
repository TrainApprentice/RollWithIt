...
public class GameController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (playerPos.z >= obstacleList[i].transform.position.z)
            {
    ...
    public void Remove(GameObject patch)
    {
        goList.Remove(patch);
        Destroy(patch);
    }
    public void CreateObstacles(int obstacleMax, GameObject patch)
    {
        ...
        for (int i = 0; i < obstacleMax; i++)
        {
            ...
            Vector3 randSpawnPoint = new Vector3(Random.Range(-150f, 150f), 13f, Random.Range(patch.transform.position.z - 200f, patch.transform.position.z + 200f));
    ...
    public void RemoveObstacles(GameObject randSpawn)
    {
